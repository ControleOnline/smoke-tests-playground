---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/smoke-tests-playground, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/smoke-tests-playground`.
...
- Checkout local: `smoke-tests-playground`
- Tipo: bundle Symfony
- Família: backend
